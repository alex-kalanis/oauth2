...
namespace Tests\Picabo\OAuth2\Storage;
...
class TokenContextTest extends TestCase
{
    ...
    public function testGetInvalidToken(): void
    {
        ...
        }, \Picabo\OAuth2\Exceptions\InvalidStateException::class);
    }
    ...
    {
        parent::setUp();
        $this->token = Mockery::mock(\Picabo\OAuth2\Storage\ITokenFacade::class);
