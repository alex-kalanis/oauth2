...
namespace Tests\Picabo\OAuth2\Storage\AccessTokens;
...
class AccessTokenFacadeTest extends TestCase
{
    ...
    public function testCheckInvalidToken(): void
    {
        ...
        }, \Picabo\OAuth2\Storage\Exceptions\InvalidAccessTokenException::class);
    }
    ...
    public function testCreateToken(): void
    {
        ...
        $client = Mockery::mock(\Picabo\OAuth2\Storage\Clients\IClient::class);
    ...
    {
        parent::setUp();
        $this->storage = Mockery::mock(\Picabo\OAuth2\Storage\AccessTokens\IAccessTokenStorage::class);
        $this->keyGenerator = Mockery::mock(\Picabo\OAuth2\IKeyGenerator::class);
