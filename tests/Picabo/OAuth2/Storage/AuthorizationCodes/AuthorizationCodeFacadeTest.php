...
namespace Tests\Picabo\OAuth2\Storage\AuthorizationCodes;
...
class AuthorizationCodeFacadeTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->storage = Mockery::mock(\Picabo\OAuth2\Storage\AuthorizationCodes\IAuthorizationCodeStorage::class);
